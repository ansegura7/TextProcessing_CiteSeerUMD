 ...
 * 
 * comments: Class that contains the functions for reading text files.
*/
...
public class Reader {
	...
	public Hashtable<String, String> readFiles(String filepath) {
		return readFiles(filepath, 3500);
	}
	 ...
	 */
	public boolean saveArrayList(ArrayList<String> array, String filename) {
		boolean result;
		Writer writer = null;
